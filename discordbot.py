...
async def on_message(message):
    ...
    if message.content == "<:hello1:713004241131667528> <:hello1:713004241131667528> <:hello1:713004241131667528> ":
        # チャンネルへメッセージを送信
        await message.channel.send(f"<:hello1:713004241131667528> <:hello1:713004241131667528>")  # f文字列（フォーマット済み文字列リテラル）
